package com.example.hank.myappdemo.shareask.Utils;
...
public class ShareSDKUtils {
    ...
    public static PlatformActionListener mPlatformActionListener = new PlatformActionListener() {
        ...
        public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
            if (type.equals("login")) {
                ...
                sb.append("登录成功").append("\n");
                sb.append("openid：" + platform.getDb().getUserId()).append("\n");
                sb.append("用户名：").append(platform.getDb().getUserName());
        ...
        public void onError(Platform platform, int i, Throwable throwable) {
            ...
            if (type.equals("login")) {
                showToast("登录失败" + throwable.toString());
            } else {
    ...
    public static void showToast(String msg) {
        if (mToast == null) {
            mToast = Toast.makeText(ExampleApplication.getContext(), msg, Toast.LENGTH_SHORT);
        }
        mToast.setText(msg);
        mToast.show();
    }
